...
// 根据年份和节气索引返回指定年份的二十四节气的日期。
// b 表示年份（1900 到 2100 年之间）。
// f 表示节气的索引（1 到 24）。
...
function solar2lunar(b, f, c) {
 ...
 var e, a, r = null,
  t = 0;
 b = (r = b ? new Date(b, parseInt(f) - 1, c) : new Date).getFullYear(), f = r.getMonth() + 1, c = r.getDate();
 ...
 a = leapMonth(e);
 var i = !1;
 for (e = 1; e < 13 && d > 0; e++) a > 0 && e === a + 1 && !1 === i ? (--e, i = !0, t = leapDays(l)) : t = monthDays(l, e), !0 === i && e === a + 1 && (i = !1), d -= t;
 0 === d && a > 0 && e === a + 1 && (i ? i = !1 : (i = !0, --e)), d < 0 && (d += t, --e);
 var h = e,
  D = d + 1,
  g = f - 1,
  v = toGanZhiYear(l),
 ...
 var M = !1,
  T = null;
 y === c && (M = !0, T = solarTerm[2 * f - 2]), m === c && (M = !0, T = solarTerm[2 * f - 1]);
 // 计算该日期的干支纪日
...
var calendarFormatter = {
 ...
 lunar2solar: function(b, f, c, e) {
  ...
  var n = 0,
   s = !1;
  for (d = 1; d < f; d++) n = leapMonth(b), s || n <= d && n > 0 && (t += leapDays(b), s = !0), t += monthDays(b, d);
  e && (t += a);
