window.addEventListener('load', () => {
  ...
  const openSearch = () => {
    ...
    ldd.animateIn(document.getElementById('search-mask'), 'to_show 0.5s')
    ldd.animateIn(document.querySelector('#local-search .search-dialog'), 'titleScale 0.5s')
  ...
  const closeSearch = () => {
    ...
    bodyStyle.width = ''
    bodyStyle.overflow = ''
    ldd.animateOut(document.querySelector('#local-search .search-dialog'), 'search_close .5s')
    ldd.animateOut(document.getElementById('search-mask'), 'to_hide 0.5s')
  }
