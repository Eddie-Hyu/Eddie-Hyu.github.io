...
document.addEventListener('pointermove', ({
 ...
 const newX = gsap.utils.mapRange(0, document.getElementById("helibox").innerWidth, -BOUNDS, BOUNDS, x);
 const newY = gsap.utils.mapRange(0, document.getElementById("helibox").innerHeight, BOUNDS, -BOUNDS, y);
