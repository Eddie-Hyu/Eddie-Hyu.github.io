...
>*仅支持 **中国大陆地区**，其他区域请将 [以下内容](https://jsd.cdn.zzko.cn/gh/imsyy/file/js/music/music-other.js) 替换 `music.js` 以实现音乐播放器的正常使用
