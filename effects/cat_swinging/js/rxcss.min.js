! function(t, e) {
 "object" == typeof exports && "object" == typeof module ? module.exports = e() : "function" == typeof define && define.amd ? define([], e) : "object" == typeof exports ? exports.RxCSS = e() : t.RxCSS = e()
}(this, function() {
 return function(t) {
  function e(n) {
  ...
  var a = function(t) {
   function e(e, r, n, i) {
    ...
    var s, u = this;
    o.isFunction(r) ? s = r : r && (u = r, s = r.next, n = r.error, i = r.complete, o.isFunction(u.unsubscribe) && this.add(u.unsubscribe.bind(u)), u.unsubscribe = this.unsubscribe.bind(this)), this._context = u, this._next = s, this._error = n, this._complete = i
   }
  ...
  var n = window.Rx ? Rx.Observable : r(1).Observable;
  e.default = n
 }, function(t, e, r) {
  "use strict";
    ...
    return t.prototype.unsubscribe = function() {
     ...
     if (!this.closed) {
      ...
      var r = this,
       o = r._unsubscribe,
       p = r._subscriptions;
      if (this._subscriptions = null, u.isFunction(o)) {
       var h = c.tryCatch(o).call(this);
       h === a.errorObject && (e = !0, t = t || (a.errorObject.e instanceof f.UnsubscriptionError ? n(a.errorObject.e.errors) : [a.errorObject.e]))
      }
      if (i.isArray(p))
       for (var l = -1, b = p.length; ++l < b;) {
        var y = p[l];
        if (s.isObject(y)) {
         var h = c.tryCatch(y.unsubscribe).call(y);
         if (h === a.errorObject) {
          e = !0, t = t || [];
          var d = a.errorObject.e;
          d instanceof f.UnsubscriptionError ? t = t.concat(n(d.errors)) : t.push(d)
         }
        }
       }
  ...
  function s(t) {
   var e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : document.documentElement,
    r = f.default.merge.apply(f.default, i(Object.keys(t).map(function(e) {
     var r = t[e];
     return O(r) || (r = f.default.of(r)), r.map(function(t) {
      return o({}, e, t)
     })
    }))).scan(function(t, e) {
     return u({}, t, e)
  ...
  var u = Object.assign || function(t) {
   ...
   x = function t() {
    ...
    return {
     set: function(r, n) {
      return "object" !== ("undefined" == typeof r ? "undefined" : c(r)) || n ? "object" === ("undefined" == typeof n ? "undefined" : c(n)) ? Object.keys(n).forEach(function(o) {
       t(e).set(r + "-" + o, n[o])
      }) : e.style.setProperty("--" + r, S(n)) : Object.keys(r).map(function(n) {
       return t(e).set(n, r[n])
      })
     },
     get: function(t) {
  ...
  s.set = function(t) {
   ...
   return (e = x(t)).set.apply(e, n)
  }, s.get = function(t) {
   for (var e, r = arguments.length, n = Array(r > 1 ? r - 1 : 0), o = 1; o < r; o++) n[o - 1] = arguments[o];
   return (e = x(t)).get.apply(e, n)
  }, s.unit = b.default, s.rect = d.default, s.lerp = m.default, s.animationFrame = _.default, t.exports = s
 }, function(t, e) {
  "use strict";
  ...
  function o() {
   return s.default.create(function(t) {
    var e = !0,
     r = Date.now(),
     n = (Date.now(), function n() {
      var o = Date.now() - r;
      t.next(o), e && u(n)
     });
    return n(),
  ...
  Object.defineProperty(e, "__esModule", {
   value: !0
  }), e.createAnimationFrameTicker = o;
  var i = r(4),
   s = n(i),
   u = window.requestAnimationFrame || window.mozRequestAnimationFrame || window.webkitRequestAnimationFrame || window.msRequestAnimationFrame;
  e.default = o()
 }, function(t, e, r) {
  "use strict";
  ...
  var o = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function(t) {
   ...
   u = function(t) {
    return function(e, r) {
     if (null !== e && ("object" === ("undefined" == typeof e ? "undefined" : o(e)) || "array" == typeof e)) return (0, s.default)(e, function(e, n) {
      var o = (r[n] - e) * t;
      return e + o
     });
     var n = (r - e) * t;
  ...
  function o(t) {
   ...
   throw new Error(t + " is not an element.")
  }
  Object.defineProperty(e, "__esModule", {
   value: !0
  }), e.default = o;
  ...
  var n = window.Rx ? Rx.Subject : r(24).Subject;
  e.default = n
 }, function(t, e, r) {
  "use strict";
   ...
   s = {
    px: function(t) {
     return t.map(function(t) {
      return "number" == typeof t ? t + "px" : (0, i.default)(t, function(t) {
       return t + "px"
      })
     })
    }
  ...
  var n = r(1),
   o = r(32);
  n.Observable.merge = o.merge
 }, function(t, e, r) {
  "use strict";
  var n = r(1),
   o = r(33);
  n.Observable.of = o.of
 }, function(t, e, r) {
  "use strict";
  var n = r(1),
   o = r(34);
  ...
  var n = r(1),
   o = r(37);
  n.Observable.prototype.scan = o.scan
 }, function(t, e, r) {
  "use strict";
  var n = this && this.__extends || function(t, e) {
    function r() {
   ...
   i = function(t) {
    ...
    return n(e, t), e.create = function(t) {
     ...
     return r ? r.schedule(e.dispatch, 0, {
      subscriber: t
     }) : void t.complete()
    }, e
   }(o.Observable);
  ...
  function o() {
   ...
   var r = Number.POSITIVE_INFINITY,
    n = null,
    o = t[t.length - 1];
   return u.isScheduler(o) ? (n = t.pop(), t.length > 1 && "number" == typeof t[t.length - 1] && (r = t.pop())) : "number" == typeof o && (r = t.pop()), null === n && 1 === t.length ? t[0] : new i.ArrayObservable(t, n).lift(new s.MergeAllOperator(r))
  }
  var i = r(10),
   s = r(36),
   u = r(16);
  ...
  function n(t) {
   return void 0 === t && (t = Number.POSITIVE_INFINITY), this.lift(new u(t))
  }
  var o = this && this.__extends || function(t, e) {
    function r() {
     this.constructor = t
  ...
  function n(t, e) {
   var r = !1;
   return arguments.length >= 2 && (r = !0), this.lift(new s(t, e, r))
  }
  var o = this && this.__extends || function(t, e) {
    function r() {
     this.constructor = t
  ...
  var s = function() {
   ...
   u = function(t) {
    function e(e, r, n, o) {
     t.call(this, e), this.accumulator = r, this._seed = n, this.hasSeed = o, this.index = 0
    }
  ...
  function n(t, e, r, n) {
   ...
   if (i.isArray(e)) {
    for (var l = 0, b = e.length; l < b && !h.closed; l++) h.next(e[l]);
    h.closed || h.complete()
   } else {
    ...
    if (e && "function" == typeof e[a.$$iterator])
     for (var y = e[a.$$iterator]();;) {
      ...
      if (h.next(d.value), h.closed) break
     } else if (e && "function" == typeof e[p.$$observable]) {
      var v = e[p.$$observable]();
      if ("function" == typeof v.subscribe) return v.subscribe(new f.InnerSubscriber(t, r, n));
